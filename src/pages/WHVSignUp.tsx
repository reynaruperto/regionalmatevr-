        ...
        <div className="w-[375px] h-[812px] bg-black rounded-[3rem] p-2 shadow-2xl">
          <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
              ...
              <h1 className="text-lg font-semibold text-gray-900">Working Holiday Maker Sign Up</h1>
            ...
            <div className="flex-1 px-6 py-8 overflow-y-auto">
              ...
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">
                  Join as Working Holiday Maker
                </h2>
                <p className="text-gray-600">
                  Find amazing job opportunities across Australia
                </p>
              </div>
              ...
              <div className="flex justify-center">
                <SignUp
                  forceRedirectUrl="/whv/dashboard"
                  fallbackRedirectUrl="/whv/onboarding"
                  appearance={{
                    elements: {
