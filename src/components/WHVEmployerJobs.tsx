...
const WHVEmployerJobs: React.FC = () => {
  ...
  const handleViewJob = (jobId: string) => {
    ...
    navigate(`/whv/job-details/${employerId}/${jobId}?from=whv-employer-jobs&employerId=${employerId}&tab=${tab || ''}`);
  };
...
export default WHVEmployerJobs;