...
const CandidateFullProfileCard: React.FC = () => {
  ...
  const mutualMatchCandidates: { [key: string]: MutualMatchCandidate } = {
    '4': {
      ...
      quote:
        'Ready to work hard and experience the real Australia! I bring European farming expertise and enthusiasm for learning new techniques.',
      ...
      licenses: ["Driver's License", 'Forklift License', 'First Aid Certificate'],
      availability: 'February 2025 (18 months)',
      stayDuration: '18 months',
      languages: ['English (Native)', 'French (Fluent)', 'Spanish (Basic)'],
      workExperience:
        'I have 4 years of experience working in organic farms and vineyards in France. I started as a seasonal worker and became a team supervisor. I also have construction experience helping with farm building projects and maintenance. I love working with my hands and being outdoors.',
      skillsInterests:
        'Organic farming, vineyard maintenance, basic construction, equipment operation, team leadership, outdoor work, learning new agricultural techniques, and experiencing different farming methods.',
      whyAustralia:
        'I chose Australia because of its reputation for innovative farming techniques and diverse agricultural opportunities. I want to learn about Australian farming methods, work in different climates, and experience the multicultural work environment while contributing my European farming knowledge.',
    ...
    '5': {
      ...
      name: 'Emma',
      profileImage:
        '/lovable-uploads/76ee4cf4-2a7f-4575-a02c-ba69817bfa35.png',
      quote:
        '"Canadian farm girl ready to share my agricultural knowledge with Australian farmers! I bring hands-on experience and a strong work ethic to help your operations thrive."',
      nationality: 'Canada',
      ...
      workExperience:
        'I have 8 years of hands-on farm experience in Canada, specializing in equipment maintenance and crop management. Skilled in operating heavy machinery and troubleshooting technical issues.',
      skillsInterests:
        'Heavy machinery operation, equipment maintenance, crop management, technical troubleshooting, first aid, and sustainable farming practices.',
      whyAustralia:
        'Australia offers incredible farming innovation and technology. I want to learn from Australian farmers and bring new techniques back to Canada while experiencing the amazing landscapes.',
    ...
    '6': {
      ...
      name: 'Megan',
      profileImage:
        '/lovable-uploads/8ff82176-d379-4d34-b436-f2c63b90c153.png',
      quote:
        '"Swedish efficiency meets Australian farming! I\'m passionate about sustainable agriculture and marketing farm products to reach new markets and customers."',
      nationality: 'Sweden',
      ...
      workExperience:
        'I have 7 years of combined experience in agricultural marketing and greenhouse operations. I specialize in connecting farm products with markets and understanding sustainable growing practices.',
      skillsInterests:
        'Marketing strategy, greenhouse management, organic farming, customer relations, social media marketing, and sustainable agriculture practices.',
      whyAustralia:
        'Australia has an amazing agricultural export market and innovative farming techniques. I want to learn how Australian farms market their products globally and experience the diverse agricultural regions.',
          ...
          <div className="w-full h-full flex flex-col relative bg-gray-200">
              ...
              <div className="w-full max-w-sm mx-auto bg-white rounded-3xl p-6 shadow-lg">
                ...
                <div className="space-y-3 text-sm mb-6">
                  ...
                  <div>
                    ...
                    {candidate.visa} - Expires {candidate.visaExpiry}
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="font-semibold">Licenses / Certificates:</span>{' '}
            ...
            <div className="absolute bottom-8 left-6">
              <Button
                ...
                onClick={() => navigate('/employer/matches?tab=matches')}
              >
