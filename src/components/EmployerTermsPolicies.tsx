...
const EmployerTermsPolicies: React.FC = () => {
  ...
  const keyPoints = [
    ...
    "We are committed to protecting your business privacy and data",
    "All employers must follow our community guidelines",
            ...
            <div className="flex-1 px-6 overflow-y-auto">
              ...
              <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  ...
                  your use of Regional Mate as an employer. Please review them carefully.
                </p>
              </div>
...
export default EmployerTermsPolicies;