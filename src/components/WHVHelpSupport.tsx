...
const WHVHelpSupport: React.FC = () => {
  ...
  const helpResources = [
    ...
    },
    {
      icon: BookOpen,
      title: "User Guide",
      description: "Step-by-step instructions for using Regional Mate"
    },
    {
      icon: Video,
      title: "Video Tutorials",
      description: "Watch helpful videos to get started"
    }
  ];
            ...
            <div className="flex-1 px-6 overflow-y-auto">
              ...
              <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our support team is here to help you make the most of Regional Mate. 
